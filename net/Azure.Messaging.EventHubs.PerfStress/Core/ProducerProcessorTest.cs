...
{
    public abstract class ProducerProcessorTest<TOptions> : ProducerTest<TOptions> where TOptions : PerfStressOptions
    {
        ...
        protected ProducerProcessorTest(TOptions options) : base(options)
        {
